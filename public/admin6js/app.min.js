var app = {
    ...
    generateScrollbar = function (e) {
        ...
        e.scrollbarInit ||
            ...
            ((a = e.getAttribute(app.scrollBar.heightAttr)
    ...
    handleSidebarMenuToggle = function (t, s) {
        t.map(function (e) {
            e.onclick = function (e) {
                ...
                (e.classList.contains(app.sidebar.menu.activeClass) &&
                    !a.style.display)
                    ? (e.classList.remove(app.sidebar.menu.expandClass),
                      e.classList.add(app.sidebar.menu.closedClass))
                    : (e.classList.add(app.sidebar.menu.expandClass),
                      e.classList.remove(app.sidebar.menu.closedClass)),
                    slideToggle(a, s);
            };
        });
    },
    handleSidebarMenu = function () {
        ...
        s = [].slice.call(
            document.querySelectorAll(
                e + t + " > ." + app.sidebar.menu.itemLinkClass
            )
        );
        s && handleSidebarMenuToggle(s, a);
        s = [].slice.call(
        ...
        [].slice
            ...
            .map(function (e) {
                e.onclick = function (e) {
                    ...
                    e.contains(app.sidebarEnd.collapsedClass)
                        ? e.contains(app.sidebarEnd.toggledClass)
                            ? (e.remove(app.sidebarEnd.toggledClass),
                              e.add(app.sidebarEnd.collapsedClass))
                            : (e.remove(app.sidebarEnd.collapsedClass),
                              e.add(app.sidebarEnd.toggledClass))
                        : e.add(app.sidebarEnd.collapsedClass);
                };
            }),
            [].slice
            ...
            .map(function (e) {
                e.onclick = function (e) {
                    ...
                    var e = document.querySelector("." + app.class).classList,
                        a = !1;
                    e.contains(app.sidebar.minify.toggledClass)
                        ? e.remove(app.sidebar.minify.toggledClass)
                        : (e.add(app.sidebar.minify.toggledClass), (a = !0)),
                            ...
                            t.classList.contains(app.panel.loadingClass) ||
                                ...
                                (a =
                                    document.createElement(
                                        "div"
                                    )).classList.add(app.panel.loader.class),
                    ...
                    (e.onmouseover = function () {
                        ...
                        (e.onclick = function (e) {
                            ...
                            a && (e.offsetTop, a.offsetTop),
                                ...
                                ) && e.classList.contains(app.panel.expandClass)
                                    ? (document.body.classList.remove(
                                          app.panel.expandClass
                                      ),
                                      e.classList.remove(app.panel.expandClass),
                  ...
                  (a = localStorage.getItem(e)) &&
                      ...
                      $.when(
                          ...
                          window.dispatchEvent(
                              new CustomEvent(
                                  app.panel.localStorage.loadedEvent
                              )
                          );
                      })))
                ...
                var e = document.createElement("div"),
                    a =
                        ...
                        (e.innerHTML =
                            ...
                            app.panel.localStorage.reset.modal
                                .confirmResetAttr +
            ...
            e &&
                e.map(function (e) {
                    ...
                    (e = e),
                        ...
                        (r = e.clientWidth),
                        (n = ("object" == typeof s ? s : e.querySelector(s))
                            .clientWidth),
    ...
    handleUnlimitedTopMenuRender = function () {
        ...
        function t() {
            ...
            i &&
                ...
                (r = [].slice.call(
                    ...
                    r.map(function (e) {
                        e.classList.contains("menu-control") ||
                            ((s += e.clientWidth),
                            o || (t += e.clientWidth),
                            e.classList.contains("active") && (o = !0));
                    })),
                (r = i.querySelector(
                    "." +
                        app.topMenu.control.class +
                ...
                t != s && a <= s
                    ? (r.classList.add(app.topMenu.control.showClass), (l += n))
                    : r.classList.remove(app.topMenu.control.showClass),
                (r = i.querySelector(
                    "." +
                        app.topMenu.control.class +
                        "." +
                ...
                a <= t && a <= s
                    ? r.classList.add(app.topMenu.control.showClass)
                    : r.classList.remove(app.topMenu.control.showClass),
                a <= t) &&
                ((n = t - a + l),
        ...
        e &&
            ...
            window.addEventListener("resize", function () {
                var e;
                window.innerWidth >= app.breakpoints.md &&
                    ((e = document.querySelector("." + app.topMenu.class)) &&
                        e.removeAttribute("style"),
                    (e = document.querySelector(
                        "." + app.topMenu.class + " ." + app.topMenu.menu.class
                    )) && e.removeAttribute("style"),
                        ...
                        t.map(function (e) {
                            ...
                            e !== a &&
                                ...
                                e
                                    ...
                                    .classList.remove(
                                        app.topMenu.menu.expandClass
                                    ),
                                e
                                    .closest("." + app.topMenu.menu.itemClass)
                                    .classList.add(
                                        app.topMenu.menu.closedClass
                                    ));
                        }),
                        slideToggle(a));
            };
    ...
    handleTopMenuSubMenu = function () {
        ...
        t = [].slice.call(
            document.querySelectorAll(
                e + a + " > ." + app.topMenu.menu.itemLinkClass
            )
        );
        handleTopMenuToggle(t);
        t = [].slice.call(
            document.querySelectorAll(
                e + a + a + " > ." + app.topMenu.menu.itemLinkClass
            )
        );
        handleTopMenuToggle(t),
            window.addEventListener("resize", function () {
        ...
        e &&
            (e.onclick = function (e) {
                ...
                var e = document.querySelector(
                    ...
                    e =
                        e &&
                        e.getAttribute(app.sidebar.menu.disableAnimationAttr)
                            ? 0
                            : app.sidebar.menu.animationTime;
                t &&
                    ("block" == t.style.display
                        ? a.classList.remove(app.sidebar.menu.activeClass)
                        : a.classList.add(app.sidebar.menu.activeClass),
                    slideToggle(t, e),
                    t.classList.toggle(app.sidebar.menu.expandClass));
            });
    },
                                ...
                                if (
                                    ...
                                    if (l < r && p)
                                        for (
                                            ...
                                            p.classList.add(c[d]);
                                    i.setAttribute("data-offset-top", a),
                                        i.setAttribute(
    ...
    handleAjaxMode = (() => {
        ...
        return {
            ...
            initDefaultUrl: function () {
                var e;
                (this.emptyHtml =
                    r && r.emptyHtml ? r.emptyHtml : app.ajax.error.html),
                    (this.defaultUrl =
                        r && r.ajaxDefaultUrl ? r.ajaxDefaultUrl : ""),
            ...
            checkSidebarActive: function (e) {
                ...
                e &&
                    ...
                    (a = e.closest("." + app.sidebar.menu.itemClass)) &&
                        a.classList.add(app.sidebar.menu.activeClass),
                    (t = getParents(e))) &&
                    t.map(function (e) {
                        e.classList &&
            ...
            checkLoading: function (e) {
                var a;
                e
                    ? ((e = document.querySelector(app.ajax.loader.id)) &&
                          e.remove(),
                      (a = document.querySelector("." + app.content.class)) &&
                          a.classList.remove("position-relative"),
            ...
            renderAjax: function (e, a, t) {
                ...
                o &&
                    ...
                    a &&
                        ((s = a.getAttribute("data-type")
                            ? a.getAttribute("data-type")
                            : s),
                        (targetDataDataType = a.getAttribute("data-data-type")
                            ? a.getAttribute("data-data-type")
                            : s)),
                    ((l = new XMLHttpRequest()).onreadystatechange =
                        function () {
                            l.readyState == XMLHttpRequest.DONE &&
                                (200 == l.status
                                    ? setInnerHTML(o, l.responseText)
                                    : 400 == l.status
                                    ? (console.log("There was an error 400"),
                                      setInnerHTML(o, emptyHtml))
                                    : console.log(
        ...
        if (t) {
            if (
                (e.appContentFullHeight &&
                    t.classList.add(app.content.fullHeight.class),
                e.appSidebarLight)
            ) {
            ...
            if (
                (e.appSidebarEnd &&
                    t.classList.add(app.layout.sidebarEnd.class),
                e.appSidebarWide &&
                    t.classList.add(app.layout.sidebarWide.class),
                e.appSidebarMinified &&
                    t.classList.add(app.layout.sidebarMinified.class),
                e.appSidebarTwo &&
                    ...
                    (a = document.querySelector(
                        "." +
                            ...
                            app.sidebarEnd.mobile.toggleAttr +
                            "]"
                    )) && a.classList.remove(app.helper.display.none),
                    (a = document.querySelector(
                        "." + app.header.class + " ." + app.header.brand.class
                    ))) &&
                    a.classList.remove(app.helper.margin.left[0]),
                e.appSidebarTransparent &&
                    (a = document.querySelector("." + app.sidebar.class)) &&
                    a.classList.add(app.sidebar.transparent.class),
                e.appSidebarSearch &&
                    (a = document.querySelector(
                        "." +
                            app.sidebar.class +
                    ...
                    a.classList.remove(app.sidebar.search.hideClass),
                e.appSidebarHover && t.classList.add(app.sidebar.hover.class),
                e.appTopMenu &&
                    (t.classList.add(app.layout.topMenu.class),
                    (a = document.querySelector(
                        "." +
                            app.header.class +
                            " [" +
                    ...
                    a.classList.remove(app.helper.display.none),
                e.appWithoutHeader &&
                    (t.classList.add(app.layout.withoutHeader.class),
                    (a = document.querySelector("." + app.header.class))) &&
                ...
                e.appWithoutSidebar &&
                    ...
                    (a = document.querySelector(
                        "." +
                            ...
                            app.sidebar.mobile.toggleAttr +
                            "]"
                    )) && a.classList.add(app.helper.display.none),
                    (a = document.querySelector("." + app.sidebar.class)) &&
                        (a.style.display = "none"),
                    (a = document.querySelector("." + app.sidebar.bg.class)) &&
                        (a.style.display = "none"),
                    (a = document.querySelector(
                ...
                e.appHeaderInverse &&
                    (a = document.querySelector("." + app.header.class)) &&
                    a.setAttribute(app.darkMode.attr, app.darkMode.value),
                e.pageContentFullWidth &&
                    (a = document.querySelector("." + app.content.class)) &&
                    a.classList.add(app.content.fullWidth.class),
                e.appClass)
            )
                for (var l = e.appClass.split(" "), o = 0; o < l.length; o++)
                    t.classList.add(l[o]);
            if (e.appContentClass)
                if ((a = document.querySelector("." + app.content.class)))
                    for (
    ...
    handleClearPageOption = function (e) {
        ...
        if (t) {
            if (
                (e.appContentFullHeight &&
                    t.classList.remove(app.content.fullHeight.class),
                e.appSidebarLight)
            ) {
                var s = document.querySelector(
                    "." +
            ...
            if (
                (e.appSidebarEnd &&
                    t.classList.remove(app.layout.sidebarEnd.class),
                e.appSidebarWide &&
                    t.classList.remove(app.layout.sidebarWide.class),
                e.appSidebarMinified &&
                    t.classList.remove(app.layout.sidebarMinified.class),
                e.appSidebarTwo &&
                ...
                e.appSidebarTransparent &&
                    (a = document.querySelector("." + app.sidebar.class)) &&
                    a.classList.remove(app.sidebar.transparent.class),
                e.appSidebarSearch &&
                    (a = document.querySelector(
                        "." +
                            app.sidebar.class +
                    ...
                    a.classList.add(app.sidebar.search.hideClass),
                e.appSidebarHover &&
                    t.classList.remove(app.sidebar.hover.class),
                e.appTopMenu &&
                    (t.classList.remove(app.layout.topMenu.class),
                    (a = document.querySelector(
                        "." +
                            app.header.class +
                            " [" +
                ...
                e.appHeaderInverse &&
                    (a = document.querySelector("." + app.header.class)) &&
                    a.removeAttribute(app.darkMode.attr),
                e.appWithoutSidebar &&
                    ...
                    a.removeAttribute("style"),
                e.appWithoutHeader &&
                    (t.classList.remove(app.layout.withoutHeader.class),
                    (a = document.querySelector("." + app.header.class))) &&
                    a.removeAttribute("style"),
                e.appContentFullWidth &&
                    (a = document.querySelector("." + app.content.class)) &&
                    a.classList.remove(app.content.fullWidth.class),
                e.appContentClass)
            )
                if ((a = document.querySelector("." + app.content.class)))
                    for (
            ...
            e.map(function (e) {
                ...
                switch (a) {
                    ...
                    case "height":
                        ...
                        break;
                    case "number":
                        for (var o = e, r = countDecimals(l), t = r; 0 < t; )
                            t--;
                        let s = () => {
                            var e = +l.replace(",", ""),
                                a = +(o.count || 0),
                            ...
                            a < e
                                ? ((o.innerText = convertNumberWithCommas(
                                      (a = a + t).toFixed(r)
                                  )),
                                  (o.count = a),
                                  setTimeout(s, 1))
                                : (o.innerText = convertNumberWithCommas(e));
                        };
                        s();
                        break;
                    case "class":
    ...
    handleToggleClass = function () {
        ...
        e &&
            e.map(function (e) {
                e.onclick = function (e) {
                    e.preventDefault();
                    var e = this.getAttribute(app.toggleClass.targetAttr)
    ...
    handleDismissClass = function () {
        ...
        e &&
            e.map(function (e) {
                e.onclick = function (e) {
                    e.preventDefault();
                    var e = this.getAttribute(app.dismissClass.targetAttr)
        ...
        [].slice
            ...
            .map(function (s) {
                s.onclick = function (e) {
                    e.preventDefault();
                    var e = s.getAttribute(app.scrollTo.targetAttr)
                            ? this.getAttribute(app.scrollTo.targetAttr)
                            : this.getAttribute("href"),
                        e = document.querySelectorAll(e)[0],
                        a = document.querySelectorAll("." + app.header.class)[0]
                            .offsetHeight,
        ...
        return {
            ...
            initSidebar: function () {
                handleSidebarMenu(),
                    ...
                    handleSidebarSearch(),
                    (a && a.disableSidebarScrollMemory) ||
